...
Route::middleware(['auth:owner'])->group(function () {
    ...
    Route::get('/export/pdf', [DashboardController::class, 'webExportManagement'])->name('export.pdf');
    Route::get('/export/pdf/print', [DashboardController::class, 'webExportPrint'])->name('export.pdf.print');
